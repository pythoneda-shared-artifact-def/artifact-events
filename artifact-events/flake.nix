# artifact-events/flake.nix
#
# This file packages pythoneda-shared-artifact/artifact-events as a Nix flake.
#
# Copyright (C) 2023-today rydnr's pythoneda-shared-artifact/artifact-events-artifact
#
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-shared-artifact-artifact-events-default;
          pythoneda-shared-artifact-artifact-events-default =
            pythoneda-shared-artifact-artifact-events-python311;
          pythoneda-shared-artifact-artifact-events-python38 =
            shared.devShell-for {
              banner = "${
                  pythoneda-shared-pythoneda-banner.packages.${system}.pythoneda-shared-pythoneda-banner-python38
                }/bin/banner.sh";
              package =
                packages.pythoneda-shared-artifact-artifact-events-python38;
